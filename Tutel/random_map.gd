...
#	grass_material.shader = CanvasItemMaterial
#	grass_material.set_shader_param("color", Color(0, 1, 0))

#	var path_material = ShaderMaterial.new()
#	path_material.shader = CanvasItemMaterial
#	path_material.set_shader_param("color", Color(1, 0, 0))
